...
class Classifier:
    ...
    def train(self, train_filename: str, dev_filename: str, device: torch.device):
        ...
        # 1 epoch of full finetuning
        self.optimizer = AdamW(self.model.parameters(), lr=5e-5)
        self.model.train() # for dropout during training and not inference
        training_loss = self.train_one_epoch(train_dataloader, device)
        ...
        self.optimizer = AdamW(learned_params, lr=20e-5) # Use a learning rate 4 times bigger than before to learn quicker
